      ...
      <section className="mx-auto flex max-w-6xl flex-col gap-6">
        <div className="rounded-3xl border border-white/10 bg-white/5 p-8 shadow-2xl backdrop-blur">
          ...
          <p className="max-w-2xl text-base leading-7 text-slate-300">
            ...
            события дня и фокус-время. Сюда стоит заходить утром, чтобы быстро
            понять, что требует внимания в первую очередь.
          </p>
        </div>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
            <div className="mb-5">
              ...
              <p className="mt-1 text-sm text-slate-400">
                Здесь будут отображаться просроченные задачи и активные задачи,
                у которых дата выполнения — сегодня.
              </p>
            </div>
